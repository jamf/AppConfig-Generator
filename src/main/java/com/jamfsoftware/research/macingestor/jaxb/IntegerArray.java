 ...
 *       &lt;sequence>
 *         &lt;element name="defaultValue" type="{}integerArrayValueType" minOccurs="0"/>
...
public class IntegerArray implements MACDataType {

    protected IntegerArrayValueType defaultValue;
     ...
     * @return
     *     possible object is
     *     {@link IntegerArrayValueType }
     *     
     */
    public IntegerArrayValueType getDefaultValue() {
        return defaultValue;
    }
     ...
     *     
     */
    public void setDefaultValue(IntegerArrayValueType value) {
	...
	public Object getPlistObject(java.lang.String[] submissions) {
		...
		for(int i = 0; i < array.count(); i++){
			array.setValue(i, java.lang.Integer.parseInt(submissions[i]));
		}
		return array;
	}
